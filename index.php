...
$default_timezone = 'Europe/Stockholm'; // UTC+3
...
font-size:100%;background:transparent;border:none;text-decoration:none}

html{overflow-y:scroll}body{padding:0;font:14px/18px monospace,sans-serif;color:#ffffff;background:#222222}

input,select,textarea,button{font-size:inherit;font-family:inherit}
a{width:100%;color:#b4b4b4;text-decoration:none}a:hover{color:#bbbbff}img{vertical-align:middle;border:none}
.filename a {
  width: 100%;
  display: inline-flex;
  color: #b4b4b4;
...
a img{border:none}span.gray{color:#bbbbbb}small{font-size:11px;color:#888999}p{margin-bottom:10px}
ul{margin-left:2em;margin-bottom:10px}ul{list-style-type:none;margin-left:0}ul li{padding:3px 0}
table{border-collapse:collapse;border-spacing:0;margin-bottom:10px;width:100%}
th,td{padding:4px 7px;text-align:left;vertical-align:top;border:1px solid #ddd;background:#24242b;white-space:nowrap}
th,td.gray{background-color:#242424}td.gray span{color:#bbbbbb}
tr:hover td{background-color:#555555}tr:hover td.gray{background-color:#22222244}
code,pre{display:block;margin-bottom:10px;font:14px/18px Consolas,'Courier New',Courier,monospace;border:1px dashed #ccc;padding:5px;overflow:auto}
...
.path {
  padding: 4px 7px;
  border: 1px dashed #ddddddbb;
  border-radius: 1.2px;
  background-color: #42424444;
  box-shadow: 1px 1px 2px #ffffff44, 0 0 2px #000000;
  margin: -5px 5px;
  margin-bottom: 10px;
}
.right{text-align:right}.center{text-align:center}.float-right{float:right}
.message{padding:4px 7px;border:1px solid #dddddd44;background-color:#444444}
.message.ok{border-color:green;color:green}
.message.error{border-color:red;color:red}
.message.alert{border-color:orange;color:orange}
.btn{border:0;background:#ffffff22;padding:0;margin:0;font-weight:bold;color:#bbbbb2;cursor:pointer}.btn:hover{color:#b00}
...
<?php if (isset($_GET['view']) && FM_USE_HIGHLIGHTJS): ?>
<script src="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/9.2.0/highlight.min.js" async></script>
